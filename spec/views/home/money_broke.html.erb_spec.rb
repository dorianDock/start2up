...
RSpec.describe 'home/money_broke.html.erb', type: :view do
  ...
  describe 'Display correctly the page' do
    ...
    before(:each) do
      ...
      @link_on_first_idea= FactoryGirl.create(:useful_link, is_public: true, useful_link_category_id:FakeLinkCategories::MONEY)
      @link_on_first_idea.save!
      @link_on_second_idea= FactoryGirl.create(:useful_link, is_public: true, useful_link_category_id:FakeLinkCategories::MONEY)
